...
export default class App extends React.Component {
	...
	render() {
		return (
			<Router>
				<div className="App">
					<Navbar notification={this.state.notification} loggedOut={this.loggedOut} logged={this.state.permissions} schedule={this.can(this.permissions.schedule, this.state.permissions)} library={this.can(this.permissions.library, this.state.permissions)}/>
					<Switch>
						<Route exact path="/">
